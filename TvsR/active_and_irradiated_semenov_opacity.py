...
from Disks.TvsR.SemenovOpacity import get_Semenov_opacity as kappa
...
def active_and_irradiated_semenov_opacity(a,Mstar,Rstar,Tstar,
                                  diskMassFrac=0.01,amin=None,aout=100.,sampled_ts=np.linspace(10,3000,5)):
    ...
    while True:
        ...
        rim_temp=zero_find(thefunc,new_sampled_ts)
    ...
    for ra in zip(a_au,alphas):
        ...
        Tr=np.r_[Tr,zero_find(thefunc,sampled_ts)]
